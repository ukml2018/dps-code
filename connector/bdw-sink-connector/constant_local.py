...
KAFKA_SASL_PASSWORD= os.getenv('KAFKA_SASL_PASSWORD', 'Dksm9Za*d7KsnhMXab6edMQP')
...
# SINK_DB_PASSWORD = os.getenv("SINK_DB_PASSWORD", "ThisIs1Pass4DMCdev!")
...
SINK_DB_PASSWORD = os.getenv("SINK_DB_PASSWORD", "EyeBeeM!01")
...
SINK_SOURCE_PASSWORD = os.getenv("SINK_SOURCE_PASSWORD", "EyeBeeM!01")
...
SINK_TARGET_PASSWORD = os.getenv("SINK_TARGET_PASSWORD", "EyeBeeM01!")
...
# SINK_TARGET_PASSWORD = os.getenv("SINK_TARGET_PASSWORD", "aepDemoPass$")
...
# SINK_TARGET_PASSWORD = os.getenv("SINK_TARGET_PASSWORD", "mysecretpassword")
...
SINK_DB_PASSWORD = os.getenv("SINK_DB_PASSWORD", "!234Qwer")
