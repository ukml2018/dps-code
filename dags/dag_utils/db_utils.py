    ...
    with engine.connect() as connection:
        for csv in csv_list:
            ...
            try:
                ...
                logger.info("Copy sql: {}".format(sql))
...
def load_config(conn_str: str, pipeline_id: str)-> dict:
    ...
    with engine.connect() as connection:
        sql = f"""
            with conformed as(
            select poo.pipeline_id, c.operation_id , c.db_type, c.db_server, c.db_name, c.db_port, c.db_user, c.db_psw, c.dbt_project, c.el_rest, c.dbt_models
            ...
            select poo.pipeline_id, c2.operation_id , c2.operation_id , c2.db_type, c2.db_server, c2.db_name, c2.db_port, c2.db_user, c2.db_psw, c2.dbt_project, c2.dbt_models
            from config.pipeline_operation_order poo 
            ...
            c.db_type as conformed_db_type, c.db_server as conformed_db_server, c.db_name as conformed_db_name, c.db_port as conformed_db_port, c.db_user as conformed_db_user, c.db_psw as conformed_db_psw, c.dbt_project as conformed_dbt_project, c.el_rest as el_rest, c.dbt_models as conformed_dbt_models,
            c2.db_type as consumption_db_type, c2.db_server as consumption_db_server, c2.db_name as consumption_db_name, c2.db_port as consumption_db_port, c2.db_user as consumption_db_user, c2.db_psw as consumption_db_psw, c2.dbt_project as consumption_dbt_project, c2.dbt_models as consumption_dbt_models,
        ...
        for row in result:
            ...
            app_config['conformed_dbt_models'] = row.conformed_dbt_models
            ...
            app_config['consumption_dbt_models'] = row.consumption_dbt_models
