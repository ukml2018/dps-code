...
with source_data as (
    SELECT
            ...
            {{ col_cast("'1'", "varchar", "10") }} 	as ev_src_sys_cd,
            {{ col_cast("'1'", "varchar", "256") }} 	as ev_src_sys_unq_key_txt,
