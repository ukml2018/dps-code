{{ config(materialized='incremental', alias='sa_ar_to_sa_grp', unique_key='ar_id')}} 
...
with source_data as (
    SELECT
            ...
            {{ col_cast("'1'", "varchar", "32") }} 	as ar_to_grp_rl_ty_id,
            ...
            {{ col_cast("'1'", "varchar", "10") }} 	as grp_src_sys_cd,
            {{ col_cast("'1'", "varchar", "256") }} 	as grp_src_sys_unq_key_txt,
